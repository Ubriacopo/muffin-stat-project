...
The K-fold CV estimates results lead toa better model than the previously built ones as shown in the table\ref{tab:kfoldxception}.
The final trained model has \textit{Xception} has $acc=99.24\%, l_{0-1}=00.76$ which is consistent with the expected values by K-fold CV.
